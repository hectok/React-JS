...
import { borrarMensaje, crearMensaje, leerMensaje, vaciarMensajes } from '../../redux/actions/mensajes.js';
...
function Mensajes() {
    ...
    let iniciar = () => {dispatch(iniciarSesion({}));}
    let cerrar = () => {dispatch(cerrarSesion());}
